...
class DbConfig:
    ...
    def from_env(env: Env):
        ...
        port = env.int("POSTGRES_PORT", DbConfig.port)
        return DbConfig(
...
class TgBot:
    ...
    def from_env(env: Env):
        ...
        redaction_id = env.int('REDACTION_ID')
        free_group_id = env.int('FREE_GROUP_ID')
        return TgBot(redaction_id=redaction_id, token=token, admin_ids=admin_ids, free_group_id=free_group_id)
...
class Miscellaneous:
    ...
    def from_env(env: Env):
        ...
        """
        ai_api_token = env.str('OPEN_AI_TOKEN')
        anthropic_api_token = env.str('ANTHROPIC_AI_TOKEN')
        os.environ["OPENAI_API_KEY"] = ai_api_token
        os.environ["ANTHROPIC_API_KEY"] = anthropic_api_token
        return Miscellaneous(open_ai_token=ai_api_token, anthropic_ai_token=anthropic_api_token)
